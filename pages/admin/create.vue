<template>
  ...
  >
    ...
    <el-dialog title="Препросмотр" :visible.sync="previewDialog">
    ...
    <el-upload
      ...
      :before-remove = "handelImageRemove"
      :auto-upload="false"
    >
      <i class="el-icon-upload"></i>
      <div class="el-upload__text">Перетащите картинку <em>или нажмите</em></div>
      <div class="el-upload__tip" slot="tip">Файлы с расширением jpg/png, не более 500kb</div>
    </el-upload>
...
export default {
  ...
  methods: {
    ...
    handelImageRemove(file, fileList) {
      this.image = null;
    },
    onSubmit() {
